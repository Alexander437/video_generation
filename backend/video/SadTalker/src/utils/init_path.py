...
def init_path(checkpoint_dir, config_dir, size=512, old_version=False, preprocess='crop'):
    if old_version:
        ...
        print(
            "WARNING: The new version of the model will be updated by safetensor, you may need to download it "
            "mannully. We run the old version of the checkpoint this time!")
        use_safetensor = False
