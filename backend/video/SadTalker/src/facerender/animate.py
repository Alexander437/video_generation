...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        if 'full' in preprocess.lower():
            ...
            paste_pic(path, pic, crop_info, new_audio_path, full_video_path, extended_crop = True if 'ext' in preprocess.lower() else False)
